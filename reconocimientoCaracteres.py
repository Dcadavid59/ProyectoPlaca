...
def get_hog():
    winSize = (20,20)   # tamaño imagen 20x20
    blockSize=(8,8)     # tamaño del cuadro
    blockStride = (4,4) # paso ventana
    cellSize=(8,8)      
    nbins = 9           # cantidad de barras a utilizar
    derivAperture = 1   # parametro de convergencia
    winSigma = 2.       # Eliminar ruido en la imagen
    histrogramType = 0
    L2HysThreshold = 0.2
    gammaCorrection = 1
    nlavels = 64
